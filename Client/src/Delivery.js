      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            id="express"
            name="deliveryType"
            value="Express Delivery (+Rs 90)"
            onChange={handleInputChange}
          />
          <label htmlFor="express">Express Delivery (+Rs 90)</label><br/>
          <input
            type="radio"
            id="normal"
            name="deliveryType"
            value="Normal Delivery (Free)"
            onChange={handleInputChange}
          />
          <label htmlFor="normal">Normal Delivery (Free)</label><br/>
        </div>
        ...
        <div>
          ...
          <input
            ...
            id="cashOnDelivery"
            name="paymentType"
            value="Cash on Delivery (+Rs 50)"
            onChange={handleInputChange}
          />
          <label htmlFor="cashOnDelivery">Cash on Delivery (+Rs 50)</label><br/>
          <input
            type="radio"
            id="online"
            name="paymentType"
